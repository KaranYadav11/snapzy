...
function Convo() {
  ...
  return (
    <div className="bg-black relative  h-screen w-full">
      <section className="flex flex-col fixed w-full py-1 px-2 h-full">
        <div className="flex bg-gradient-to-br px-4   from-purple-700 via-pink-500 to-red-400 rounded-2xl mt-1 h-20 justify-between items-center z-10">
          <div className="flex items-center  gap-3">
            <div className="relative">
              ...
              {isOnline && (
                <div
                  className={`absolute bottom-1.5 right-0.5 z-50 size-2.5 ${
                    isOnline ? "bg-emerald-400" : ""
                  } 
                  rounded-full ring-1 ring-black/20`}
                />
              )}
            </div>
            <div
        ...
        <div className="flex mb-1 items-center p-2 md:mx-1 rounded-xl bg-gradient-to-br from-purple-700 via-pink-500 to-red-400">
          <Input
