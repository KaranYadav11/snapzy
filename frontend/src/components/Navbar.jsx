...
function Navbar() {
  ...
  return (
    <div className="fixed w-screen z-50 h-14 justify-between px-4 backdrop-blur-lg flex items-center md:hidden top-0 bg-black/60 text-lato text-white pb-2 font-bold">
